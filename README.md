...
| [<img src="https://images-na.ssl-images-amazon.com/images/I/51OK2x1LvbL.jpg" width="200">](https://www.amazon.co.jp/dp/4065128447/) | 問題解決力を鍛える!アルゴリズムとデータ構造 | 大槻兼資 | アルゴリズムの入門書です。学部で勉強したアルゴリズムの復習を兼ねて、一度こういう本を読んでおくとよいです。この本は難易度的には競技プログラミング入門というぐらいで十分に全て理解できるうえ、非常にまとまっていて読みやすいと思います。必須度：★★★★★|
...
| [<img src="https://visionbook.mit.edu/figures/logo.jpg" width="200">](https://visionbook.mit.edu/) | Foundations of Computer Vision |  Antonio Torralba, Phillip Isola, William Freeman  | 分野を網羅する辞書系の本で、2025年現在一番新しいものです。ウェブから無料で読めます。またAIに質問出来る機能があり、日本語でも質問できるので非常に便利です。[バンドルアジャストメントについて聞いた例。](https://app.runllm.com/chat/fee97a0e-63a8-4597-a654-e99631d22663)辞書度：★★★★★ 便利度：★★★★★★★★★★ |
| [<img src="http://szeliski.org/Book/imgs/Szeliski2ndBookFrontCover.png" width="200">](http://szeliski.org/Book/) | Computer Vision: Algorithms and Applications, 2nd ed. | Richard Szeliski | 分野を網羅するタイプの分厚い本です。上記のTorallba本が出るまではコンピュータビジョンに関する網羅系の本として決定版でした。基礎的な部分についてはこちらの本のほうが詳しいかもしれないです。最近改訂されて第二版になり、深層学習の話が増えました。[無料でドラフトのpdfをダウンロード](http://szeliski.org/Book/)出来ます。少し古い初版は、[翻訳され書籍として出版](https://www.amazon.co.jp/dp/432012328X/)されています。辞書度：★★★★★ |
...
|  | 書名 | 著者 | 説明 |
| --- | --- | --- | --- |
| [<img src="https://images-na.ssl-images-amazon.com/images/I/41DPn9-Mz4L.jpg" width="200">](https://www.amazon.co.jp/dp/4320013433/) | 数値計算の常識 | 伊理正夫、藤野和建 | 数値計算という概念に対する心構えの本です。古く薄い本ですが、現代でも全くもって重要な知見にあふれています。古い良書は勉強になる度：★★★|
| [<img src="https://images-na.ssl-images-amazon.com/images/I/41xkohCdHlL.jpg" width="200">](https://www.amazon.co.jp/dp/4782851235/) | ビジョン―視覚の計算理論と脳内表現 | デビッド マー | コンピュータビジョンの創設期の思想書です。コンピュータビジョンという分野がどのような背景のもとに生まれ、どのような方向への進化が考えられていたか、述べられています。コンピュータビジョンを研究するのであれば、一読しておくとよいです。古い良書は勉強になる度：★★★|
...
| [<img src="https://m.media-amazon.com/images/I/71OmMD4O7AL._SL1412_.jpg" width="200">](https://www.amazon.co.jp/dp/4130623230/) | 科学の技法 第2版 | 若杉桂輔（編）、宮島謙（編）  | 東大理科１年の講義（初年次ゼミナール）の教科書です。アカデミックな活動のルールや作法が簡潔にまとめられています。１年生向けのテキストですが、実際に研究活動を開始する卒論生や、あるいは卒論によって研究を体験した修士学生が読むと改めて勉強になると思います。必須度：★★★★★|
